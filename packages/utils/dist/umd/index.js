...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function createInstance(defaultConfig) {
      ...
      var axios = function axios(url, userConfig) {
        return __awaiter(this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, context.request(url, userConfig)];
              case 1:
    ...
    var powerUtils = _assign({ cloneDeep: cloneDeep, axios: request, copy: copy, getQueryStringArgs: getQueryStringArgs, browser: browser }, is);
